...
aver_reward = None
allow_writing = True
reload = True # reload = True basically loads a pre-made (and pretty good) model - it's supposed to be kind of a demo
...
if reload:
    ...
    model = {}
    model['W1'] = np.random.randn(24, hl_size) / np.sqrt(24) # fills with 24 x hl_size list of random numbers (divided by sqrt(24))
